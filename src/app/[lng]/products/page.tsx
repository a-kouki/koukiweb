...
import ModelAvail from "../_components/Products_2" 
...
export async function generateMetadata(
  ...
  switch (lng){
    ...
    return {
      ...
      title: "Products - KOUKI WEB SERVICE",
      description: des,
      alternates: {
        canonical: canonical,
        languages: {
      ...
      keywords: ['Web', 'Site','Products WEB', 'Create web', 'Managed web', 'Multilingual', 'Programming', 'Web Service'],
      robots: {
            index: true,
            follow: true,
            nocache: false,
